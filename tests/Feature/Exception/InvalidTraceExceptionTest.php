...
it('makes exception with generated message', function (mixed $from, string $message) {
    ...
    'empty array' => fn () => [[], 'Invalid trace frame(s) provided: []'],
    'null frame' => fn () => [[null], 'Invalid trace frame(s) provided: [null]'],
    'non-frame array' => fn () => [
        [[]],
        'Invalid trace frame(s) provided: [[]]'
    ],
    'multiple non-frame values' => fn () => [
